...
@click.pass_context
def main(context: click.Context, dry_run: bool, log_level: str, target: str,
         target_glob: str, target_skip_glob: str, no_log_timestamps: bool, root: str,
         internal_inside_unshare: bool, include_tags: tuple[TestTag, ...],
         exclude_tags: tuple[TestTag, ...], runner: str, chip_tool: OptPath) -> None:
...
@click.pass_context
def cmd_run(context: click.Context, iterations: int, all_clusters_app: OptPath,
            lock_app: OptPath, ota_provider_app: OptPath, ota_requestor_app: OptPath,
            fabric_bridge_app: OptPath, tv_app: OptPath, bridge_app: OptPath,
            lit_icd_app: OptPath, microwave_oven_app: OptPath, rvc_app: OptPath,
            network_manager_app: OptPath, energy_gateway_app: OptPath,
            energy_management_app: OptPath, closure_app: OptPath,
            matter_repl_yaml_tester: OptPath, chip_tool_with_python: OptPath,
            pics_file: Path, keep_going: bool, test_timeout_seconds: int | None,
