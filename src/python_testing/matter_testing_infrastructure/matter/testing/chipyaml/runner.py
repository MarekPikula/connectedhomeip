...
CONTEXT_SETTINGS = {
    'default_map': {
        'chiptool': {
            'adapter': 'matter.testing.chipyaml.adapters.chiptool.adapter',
        ...
        'app1': {
            ...
            'adapter': 'matter.testing.chipyaml.adapters.placeholder.adapter',
        ...
        'matter-repl': {
            'adapter': 'matter.testing.chipyaml.adapters.repl.adapter',
            'runner': 'matter.testing.chipyaml.adapters.repl.runner',
        },
    },
