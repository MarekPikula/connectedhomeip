...
from matter.testing import DEFAULT_CHIP_ROOT, runner
from matter.testing.chiptest.test_definition import TestDefinition, TestTag, TestTarget
...
_YAML_TEST_SUITE_PATH = DEFAULT_CHIP_ROOT / "src/app/tests/suites"
...
def _GetManualTests() -> Set[str]:
    ...
    for item in _LoadManualTestsJson(str(_YAML_TEST_SUITE_PATH / "manualTests.json")):
