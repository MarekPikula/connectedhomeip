...
_CLUSTER_XML_DIRECTORY_PATH = DEFAULT_CHIP_ROOT / "src/app/zap-templates/zcl/data-model/"
...
async def main(setup_code, yaml_path, node_id, pics_file):
    ...
    with tempfile.NamedTemporaryFile() as chip_stack_storage:
        ...
        try:
            ...
            clusters_definitions = SpecDefinitionsFromPaths([str(_CLUSTER_XML_DIRECTORY_PATH / 'chip/*.xml')])
