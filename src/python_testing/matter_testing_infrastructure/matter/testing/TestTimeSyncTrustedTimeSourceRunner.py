...
DEFAULT_ALL_CLUSTERS = DEFAULT_CHIP_ROOT / 'out/linux-x64-all-clusters-ipv6only-no-ble-no-wifi-tsan-clang-test/chip-all-clusters-app'
DEFAULT_TEST_RUNNER = DEFAULT_CHIP_ROOT / 'scripts/tests/run_python_test.py'
DEFAULT_TEST_SCRIPT = DEFAULT_CHIP_ROOT / 'src/python_testing/test_testing/TestTimeSyncTrustedTimeSource.py'
...
def main():
    ...
    parser.add_argument('--all-clusters', default=str(DEFAULT_ALL_CLUSTERS), help="All clusters application.")
    parser.add_argument('--test-runner', default=str(DEFAULT_TEST_RUNNER), help="the run_python_test.py script.")
    parser.add_argument('--test-script', default=str(DEFAULT_TEST_SCRIPT), help="The path to the TimeSyncTrustedTimeSource test.")
